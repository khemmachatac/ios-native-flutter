...
if [[ "$CONFIGURATION" == "Debug" ]]; then
  install_framework "${PODS_ROOT}/../../../../AndroidStudioProjects/Eggcial/eggcial_flutter/.ios/Flutter/engine/Flutter.framework"
  ...
  install_framework "${PODS_ROOT}/../../../../AndroidStudioProjects/Eggcial/eggcial_flutter/.ios/Flutter/App.framework"
fi
